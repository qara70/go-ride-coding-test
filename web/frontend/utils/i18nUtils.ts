...
let _polarisTranslations: TranslationDictionary | TranslationDictionary[];
...
const PLURAL_RULES_LOCALE_DATA: {
  [v: string]: () => Promise<{
    default: TranslationDictionary | TranslationDictionary[];
  }>;
} = {
...
function localResourcesToBackend() {
  return resourcesToBackend(async (locale: string) => {
